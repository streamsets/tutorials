...
* In your existing pipeline, click the connector between the GeoIP and Elasticsearch processors and select Jython Evaluator from the Add Processor list. (If the help bar doesn't display, you can turn it on: Click the Help icon in the upper right corner > Settings, clear the Hide Pipeline Creation Help Bar option.) 
...
* You can hit Preview to see and debug a subset of the data flowing through the pipeline. Or hit Run to start the pipeline and get data flowing into Elasticsearch.
