...
* You can hit Preview to see and debug a subset of the data flowing through the pipeline; Or hit Run to start the pipeline and get data flowing into Elastic.
